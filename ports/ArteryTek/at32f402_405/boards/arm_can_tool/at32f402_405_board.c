...
gpio_type *led_gpio_port[LED_NUM]        = {LED0_GPIO, LED1_GPIO};
uint16_t led_gpio_pin[LED_NUM]           = {LED0_PIN, LED1_PIN};
crm_periph_clock_type led_gpio_crm_clk[LED_NUM] = {LED0_GPIO_CRM_CLK, LED1_GPIO_CRM_CLK};
...
{
  return gpio_input_data_bit_read(USER_BUTTON_PORT, USER_BUTTON_PIN) ? 0 : 1;
}
